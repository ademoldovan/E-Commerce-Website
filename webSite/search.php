<?php
	...
	$impure_search = $_GET['search'];
	$search = str_replace("+"," ",$impure_search);
	//Get everything from database
	$sql = "SELECT * FROM produse WHERE categorie='".$search."' OR brand='".$search."' OR nume LIKE '%".$search."%'";
	...
	if($result != 0)
	{
		...
		echo "Nu s-a putut gasi un produs!";
	}
?>